...
export default function PaymentPage(){
    ...
    <CardContent>
      ...
      >
        ...
        />
          ...
          error={expiry.length >0 && expiry.length <4}
          helperText={expiry.length === 0 ? "MMYY" : expiry.length > 0 && expiry.length < 4 ?  'Invalid Expiry date' : ""}
          color="warning"
  ...
  <React.Fragment>
    <CardContent>
      ...
      <DivFlex>
      <ImageLabel>Total:</ImageLabel><ImageLabel>2,358Rs</ImageLabel></DivFlex>
      <Divider />
